function updateArray<T>(arr: T[], value: T): T[] {
...
const filterArray = <T>(arr: T[], fn: (arg: T) => boolean): T[] => {
...
const mapArray = <T, U>(arr: T[], fn: (arg: T) => U): U[] => {
...
const toDescription = (person: Person) =>
